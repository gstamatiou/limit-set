...
\todo{This is not a density per se. It is a density defined a.e. Does this make sense? }
...
\begin{proof}
    ...
    \todo{How can we show that $\vol B_R([1:0:-1]) \approx e^{2R}$?}
\end{proof}
...
\begin{lemma}[\cite{quint2002mesures}, Lemme 6.1]
    ...
    \]
\end{lemma}
\todo{Why is there a unique such projection $p_\Theta$?} 
...
(Add proof for \cref{lem:busemann_weight}}
