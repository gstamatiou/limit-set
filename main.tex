...
We consider the parabolic subgroup $P_0 = \mathrm{St}_{\SU(2,1)} [1:0:0]$ of $\SU(2,1)$.\todo{This means that it is equivariant with respect to the Adjoint action of $\Gamma$. However we are only proving uniqueness of an $\SU(2,1)$-equivariant map.}
...
\begin{proposition}
    ...
    \begin{enumerate}[label=(\roman*)]
        ...
        \end{align*}
        \item For all $x, y \in \partial \Gamma: \zeta(x), \zeta(y)$ are not transverse.
    \end{enumerate}
\end{proposition}
