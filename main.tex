...
\begin{definition}
    ...
    \[
        V = \mathbb R u_1 \bigoplus \cdot \bigoplus \mathbb R u_d
    \] 
    be a direct decomposition that is orthogonal with respect to a fixed inner-product over $V$.
    Given $\beta_2 \geq \ldots \beta_d > 0$, we define an ellipsoid about $\mathbb R u_1$ with axis lengths $\beta_2, \ldots, \beta_d$ to be the image of
    \[
        \left\{
