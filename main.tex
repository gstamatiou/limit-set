...
Let $\Gamma$ be a uniform lattice of $\SU(2,1)$, and $\eta: \Gamma \to \SL(\mathfrak{su}(2,1))$ be the restriction of the adjoint representation, i.e. $\eta(\gamma) = \Ad_{\gamma}$ for all $\gamma \in \Gamma$.
...
Letting $k_1' = Ad_{k_1}, k_2' = Ad_{k_2}$ we have that:
\[
...
We consider the section given by
\begin{align*}
    \zeta: \partial \Gamma &\to \mathcal F_{\{1, d_\Gamma + 1 \}}(\mathfrak{su}(2,1)) \simeq \mathcal P\\
    x &\mapsto (\xi^1(x), T_{\xi^1(x)} \xi^1(\partial \Gamma)) \simeq (\xi^1(x), (\d_{\xi^1(x)})^{-1}(T_{\xi^1(x)}\xi^1(\partial \Gamma))\xi^1(x)).
\end{align*}
